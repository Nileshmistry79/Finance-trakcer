class UserStocksController < ApplicationController
  ...
  def create
    if params[:stock_id].present?
      ...
      if stock
        ...
        if stock.save
          ...
          @user_stock=nil
          flash[:danger]="Stock is not avalialble"
        end  
      end 
    end  
    ...
    respond_to do |format|
      if @user_stock.save
        format.html { redirect_to my_portfolio_path, notice: "Stock #{@user_stock.stock.ticker} stock successfully added" }
  ...
  def destroy
    @user_stock.destroy
    respond_to do |format|
      format.html { redirect_to my_portfolio_path, notice: 'Stock was successfully removed from portofoli' }
